 ...
 -->
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <%
                                ...
                                int rideCount=0;
                                  try {
                            		List<Carpool> d = db.getAllDocsRequestBuilder().includeDocs(true).build().getResponse()
                            				.getDocsAs(Carpool.class);
                            		if(d != null){
                            			rideCount = d.size();
                            		}
...
<!--                                                 <div class="site-stat">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <div class="site-stat">
                                                    <span class="counter"><%=rideCount %></span>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/NewLoginController" novalidate autocomplete="off" class="idealforms login">
                            ...
                            <div class="field">
                                <input name="username" type="text" placeholder="Username" name="username">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/NewRegisterservlet" novalidate autocomplete="off" class="idealforms reg">
                            ...
                            <div class="field">
                                <input name="contactNo" type="number"  placeholder="Mobile Number">
                                <span class="error"></span>
                            </div>
                            <div class="field">
