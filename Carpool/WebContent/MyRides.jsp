...
catch(Exception e)
{
                                    ...
                                    <form action="/SearchRide" autocomplete="off" class="idealforms searchtours" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <div class="field">
                                                    <select id="search_pickUpPoint" name="startPoint" value="From">
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div class="field">
                                                    <select id="search_endcity" name="endCity">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div class="field">
                                                    <select id="destination" name="seatsAvailable">
 ...
 <%    }catch(Exception e){
        ...
        <section class="main-content">
			...
			if(d.get(i).getUserId().equals(sessionid))
			{
	...
	<script>
      ...
      function initMap() {
        var pyrmont = {lat: 42.3149 , lng: -83.036 };
