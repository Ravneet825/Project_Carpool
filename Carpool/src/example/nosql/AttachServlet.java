...
public class AttachServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//JsonObject resultObject = servlet.createCar(db, id, carpoolId, userId, seatsAvailable, carInfo, price, carpoolDate, startCity, endCity, startPoint, dropPoint, part, fileName)(db, id, name, value, part, fileName);
